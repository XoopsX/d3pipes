...
class D3pipesUtf8fromAbstract extends D3pipesJointAbstract {
	...
	function renderOptions( $index , $current_value = null )
	{
		...
		return '<input type="text" name="joint_option['.$index.']" id="joint_option_'.$index.'" value="'.htmlspecialchars($current_value,ENT_QUOTES,_CHARSET).'" size="12" /><br />'._MD_D3PIPES_N4J_UTF8FROM ;
	}
}
